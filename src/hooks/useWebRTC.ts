  ...
  const captureMedia = async (
    ...
    try {
      ...
      if (mediaType === 'video') {
        ...
        const encodings = [
          { rid: 'r0', scalabilityMode: 'S1T3', maxBitrate: 1500000 }, // Set a reasonable max bitrate
        ];
        ...
        try {
          ...
          if (track.readyState === 'live') {
            ...
            await transport.produce({
              track,
              encodings: [
                { dtx: false, scalabilityMode: 'S1T3', maxBitrate: 1500000 } // Set a reasonable max bitrate
              ] // Simplified encoding
            });
          } else {
